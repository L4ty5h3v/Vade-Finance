...
export function DepositModal({ open, onClose, onConfirm }: Props) {
    ...
    <AnimatePresence>
      {open ? (
        ...
        >
          ...
          >
            <h2 className="text-lg font-semibold text-[#13315e]">Deposit to app balance</h2>
            <p className="mt-1 text-sm text-[#5f7799]">Funds will be moved from your wallet ATA into the app funding account.</p>
